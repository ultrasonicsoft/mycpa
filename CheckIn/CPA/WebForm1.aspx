<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="CheckIn.CPA.WebForm1" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true">
        <ContentTemplate>
            ...
            <table width="100%" style="background-color: #e6e6f5" cellpadding="8px">
                <tr>
                    <td width="35%" style="background-color: #000079">
                        <asp:HyperLink ID="HyperLink3" runat="server"  NavigateUrl="~/CPA/WebForm2.aspx">View Scheduled Appointments</asp:HyperLink>
                    </td>
                    <td width="35%">
            ...
            <asp:GridView ID="gvAppointments" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                PageSize="2" AllowSorting="True" OnPageIndexChanging="gvAppointments_PageIndexChanging"
